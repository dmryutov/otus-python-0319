...
class HttpServer(unittest.TestCase):
    ...
    def test_directory_index(self):
        ...
        self.assertEqual(data.decode(), '<html>Directory index file</html>\n')
    ...
    def test_file_in_nested_folders(self):
        ...
        self.assertEqual(data.decode(), 'bingo, you found it\n')
    ...
    def test_file_with_dot_in_name(self):
        ...
        length = r.getheader('Content-Length')
        self.assertEqual(int(r.status), 200)
        self.assertIn('hello', data.decode())
    ...
    def test_filetype_js(self):
        ...
        self.assertIn(ctype, ('application/x-javascript', 'application/javascript',
                              'text/javascript'))
